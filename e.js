(function () {
    ...
    function startPlugin() {
        ...
        // 1. Capture-phase Key Listener for TV Remotes
        // This intercepts the "OK / Enter" button press before Lampa's native controller can ignore it.
            ...
            if (e.keyCode === 13 || e.key === 'Enter') {
                ...
                if (focused) {
                    ...
                    if (filterType === 'season' || filterType === 'episode') {
                        ...
                        // Forcefully trigger our custom click/enter handler
                        $(focused).trigger('click');
                    }
                }
            }
        }, true); // "true" sets this event listener to the Capture phase, giving it absolute priority
