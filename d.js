(function () {
    ...
    function startPlugin() {
        ...
        // Domestic element manipulation to show/hide items matching filters
        function applyDOMFilter() {
            ...
            setTimeout(function () {
                ...
                // Crucial step: instructs Lampa's TV navigation controller to update remote focus map
        ...
        var observer = new MutationObserver(function () {
            ...
            if (filterContainer && torrentElements.length > 0) {
                ...
                if (filterContainer.find('[data-plugin-filter-type="season"]').length === 0) {
                    ...
                    // 1. Construct & Inject Custom Season Selector Row
                    ...
                    // 2. Construct & Inject Custom Episode Selector Row
                    ...
                    // 3. Connect to Lampa's native "Reset Filter" row click
                    if (resetRow) {
                    ...
                    // Force the spatial navigation mapping of the TV to include our new rows
                    setTimeout(function () {
                        if (window.Lampa && Lampa.Controller) {
                            Lampa.Controller.enable('content');
                        }
