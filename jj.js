(function () {
    ...
    var PLUGIN_ID = 'galflix_preload_v9';
    ...
    function init() {
        ...
        /* =========================================================
           GALFLIX PRELOAD SCREEN CSS (FLEXBOX CENTERING)
           ========================================================= */

        var style = document.createElement('style');

        style.textContent = `
        /* 1. FORCE THE WHOLE OVERLAY TO TRUE TV SCREEN BOUNDS */
        ...
        /* 2. TRUE FLEXBOX CENTERING (Ignores Lampa internal offsets) */
        ...
        /* 6. STATUS PILL AT BOTTOM (DEAD CENTER OVER SOUNDBAR) */
        ...
        console.log('[GALFLIX] v9 flexbox loaded');
    }
